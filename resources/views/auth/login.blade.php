                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                            @csrf
                            <x-input-container type="text" name="email" label="Email" id="email" placeholder="Masukkan Email" value="{{ old('email') }}" required/>
                            <x-input-container type="password" name="password" label="password" id="password" placeholder="Masukkan password" required/>
                            <div class="mb-3">
